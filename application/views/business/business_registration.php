                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="logopath">Logo Path</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="logopath" name="logopath" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
